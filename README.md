...
Handbook:[https://jcwinning.github.io/Into_sql/](https://jcwinning.github.io/Into_sql/)
...
- [DuckDB](https://duckdb.org/) for SQL examples
- [R](https://cran.r-project.org/) with tidyverse for data manipulation
- [Python](https://www.python.org/) with pandas and polars
- [Babelquarto](https://github.com/paithiov909/babelquarto) for multilingual support
